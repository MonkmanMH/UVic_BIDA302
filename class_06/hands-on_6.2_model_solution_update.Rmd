...
This code creates a regression model object, `mod_sim1`
...
We can also see how well the data predicts the line, by examining the summary statistics of the model:
...
The way to read this is that we will get 8,439 (8.439 * 1000) units sold with zero youtube advertising, but with every dollar of youtube spending we would expect an increase of 0.48 in sales. So if we spent $1,000, we would see a total of 56.4 units sold (`sales = 8.44 + 0.048 * 1000`) 
...
-30-
=======
>>>>>>> 1eebe532f08e60d4f13ed4b9cf8789bb24a1f96e
