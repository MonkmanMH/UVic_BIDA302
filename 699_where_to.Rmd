...
I have started to write a book that introduces these techniques. _The Data Preparation Journey: Finding Your Way with R_ will be published by CRC Press as part of "The R Series". I am hoping to get this completed by mid-2022.

## R Programming

If you are looking to move deeper into using R as a programming tool, I recommend two very different books:
...
1. The twitter hashtag #rstats provides a steady stream of questions and answers, links to new packages, and other news. You can find me at @monkmanmh.
...
I started to list a variety of places that I have heard about, but since I have no first-hand experience with them, I don't think it's appropriate that I endorse them here. With that said, if you ask about a specific course or programme, I'll tell you what I have heard.
