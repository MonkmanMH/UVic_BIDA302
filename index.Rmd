...
![R Cookbook](static/img/rc2e_500.jpg)
...
The book's layout is in 12 chapters, each corresponding to the 12 half-day lessons of the course:
...
* Day job: BC Stats: 1993 to present (with 5 year gap)
...
* My coding started writing FORTRAN on punch cards

  - I don't believe there is any benefit in learning things "the hard way"
  
  - In this course we use far better technology that will allow you to do better data analysis more quickly than was possible when I started down this path
