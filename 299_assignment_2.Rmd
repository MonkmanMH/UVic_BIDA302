...
# Assignment week 2 - data wrangling & import {#assignment2}
...
>
>You have the option to use the `clean_names()` function in the {janitor} >package to resolve this. You can find more information about the package in the course book ["Utilities" chapter](#utilities).
>
