...
Remember that you have the option to use the functions in the {janitor} package to resolve this!
...
e. Use your data manipulation skills to answer the following questions:
  ...
  * Does that mine hold the record for the most silver mined during a single year in B.C.?
