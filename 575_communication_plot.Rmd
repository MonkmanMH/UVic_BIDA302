...
For another example of this sort of labeling, see [_R for Data Science_ (2nd ed.), "Graphics for Communication: Annotations"](https://r4ds.hadley.nz/communication#annotations).
...
For the next step we will change the colour palette, using `scale_colour_manual()`. Remember that in the scale functions, the type of data matters—if it's a categorical variable, a "discrete" function will be required. 
