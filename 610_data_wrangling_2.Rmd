...
canpop %>% 
  mutate(pt_grp = case_when(
    ...
    province_territory == "Quebec" ~ "Quebed",
...
In this example from the [`case_when()` reference page:](https://dplyr.tidyverse.org/reference/case_when.html), it uses different combinations of three variables to create a single fourth variable.
