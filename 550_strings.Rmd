...
In the above example, the tab symbol is the separator, and there's only one per line. But what if it were spaces, and we wanted to separate on only the first space?
