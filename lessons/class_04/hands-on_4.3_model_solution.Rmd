...
To our object "pl_sim1" (for "plot_sim1") we can add the line using the `geom_line()` function. Note that in the first solution, the data is specified using the `df$var` syntax.
