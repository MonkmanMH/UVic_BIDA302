...
subtitle: "2021-03-13 and 2021-03-14"
...
1. Describe the fundamental elements of data manipulation including reshaping data, 

2. Demonstrate how these can be applied in a data analytics context using {tidyr},

3. Generate and manipulate the formatting of an R Markdown document, and

4. Successfully import CSV and Excel files into R.
...
|2b          | 11:15 to 11:45 | Running R Markdown | &#8212; |
|2c          | 11:45 to 12:00 | Questions? Comments? <br> Wrap up | &#8212; |
|**Sunday**     | &#8212;  | &#8212; | &#8212; |
