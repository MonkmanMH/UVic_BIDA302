...
Text: Garrett Grolemund and Hadley Wickham, [R for Data Science](https://r4ds.had.co.nz/)

Additional materials: see [course materials]()
...
|---        |:---  |:---      |:---:  |
|1          | 2019-11-02 | Why code? Why R? <br> Introduction to R, RStudio, and R Markdown <br> Programming foundations <br> The data science process and data wrangling <br> Basic data manipulations | &#8212; |
|2          | 2019-11-09 | Good coding habits <br> Tidy data <br> Data wrangling: the basics <br> R Markdown: the next level | &#8212; |
|3          | 2019-11-16 | Writing your own functions <br> Importing and exporting data: part 1 <br> Data wrangling: relational data <br> Excel: macros and VBA | &#8212; |
|4          | 2019-11-23 | An introduction to modeling <br> Working with dates <br> Working with strings <br> Importing and exporting data: part 2 <br> Python: the other data science language | &#8212; |
|5          | 2019-11-30 | What-if scenarios and forecasting (R and Excel) <br> R Markdown: moving beyond documents and notebooks <br> Incorporating Python into workflows | &#8212; |
|6          | 2019-12-07 | Project presentations <br> Where to from here? Other data analytics coding challenges | &#8212; |
