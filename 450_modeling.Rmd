...
`r round(summary(mod_sim1)$coefficients[1, 1], 2)` + 
`r round(summary(mod_sim1)$coefficients[2, 1], 4)` * the value of `x`.

If `x` = 150, then `y` = `r round(summary(mod_sim1)$coefficients[1, 1], 2)` + (`r round(summary(mod_sim1)$coefficients[2, 1], 4)` * 2.5), which is `r round(summary(mod_sim1)$coefficients[1, 1], 2) + (round(summary(mod_sim1)$coefficients[2, 1], 4) * 2.5)`. 
