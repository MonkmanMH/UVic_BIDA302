...
The Multiple and Adjusted R-squared statistics tells us how well the line fits the points...this number ranges between 0 (no fit at all) and 1 (where all the X and Y values fall on the line). If the relationship is negative (as X goes up Y goes down), it will be in the range from -1 to 0. In this case, it's 0.88, which is a very good fit.
