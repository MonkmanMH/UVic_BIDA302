...
![New Housing Price Index, B.C. and Canada](static/img/NHPI_plot.png)
...
* "new_housing_price_indexes", but total (not house and land separately)
...
NHPI_table4 %>%
  flextable() %>% 
  add_footer(glue("Source: Statistics Canada, Table {table_id}"))
