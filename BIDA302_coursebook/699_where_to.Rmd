...
* compare the contents of Excel files ([{waldo}](https://waldo.r-lib.org/)), 

* pull data from the BC Government's data catalogue ([{bcdata}](https://bcgov.github.io/bcdata/)), 


Here's a list of some of the most useful: Garrett Grolemund,  ["Quick list of useful R packages"](https://support.rstudio.com/hc/en-us/articles/201057987-Quick-list-of-useful-R-packages) (2021-03-18)
...
1. The twitter hashtag #rstats 

2. Conferences, meet-ups, and other events. There are various events targeted to particular disciplines, regions, or industries that are either all-R or include R as part of their mix.

3. Blog articles. [R-bloggers](https://www.r-bloggers.com/) is an aggregator of people writing blog articles about R. 
