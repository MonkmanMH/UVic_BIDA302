...
Imagine you have a directory full of Excel files that you want to read and then combine into a single dataframe. 

The steps are 

1. Create a list with the names of the files of interest (that is, the Excel files) in the sub-folder "data_monthly". 
