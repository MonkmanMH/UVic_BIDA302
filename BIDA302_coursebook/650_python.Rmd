...
![_Python logo_](static/img/python-logo-master-v3-TM-flattened.png)
...
![_VW Beetle dashboard_](static/img/VW_dashboard.jpg)

Python is a general purpose programming language, so it is like an engine.

It can power a car...or a boat, or a water pump, or ...

![VW Beetle engine](static/img/1965_Volkswagen-Bug-Which-Came-First-Engine_List-L_crop.jpg)
...
The libraries for this are listed below in the [@python-resources] section.
...
![_{reticulate} hex_](static/img_tidyverse/reticulate-735.jpg)
...
Assign the python data frame "flights" created above to an R object
...
Wes McKinney, [_Python for Data Analysis_, 2nd ed.](https://wesmckinney.com/pages/book.html), 2017—McKinney is the lead developer behind the pandas library
...
![reticulated Python](static/img/reticulated_python.png)
