...
> Once you have submitted your assignment, I will be hitting the "Preview" button -- please ensure that the output renders correctly.
...
>
>a. Load this table, and take a look at it. Why does this table not conform to the tidy principles? (See the "Tidy Data" chapter in _R4DS_.)
>
...
> a. What happens when you repeat the first chunk of code to calculate the average displacement of each class of cars but with the new object `mpg_class_by_cyl`?
