...
Now we can use that function to calculate any number of circle areas. Let's say we have a tibble with 10 observations of the odd numbers between 1 and 19, where `circle_r` is the radius of our circle.

```{r}

my_circles <- tibble(circle_r = seq(1, 20, 2))
