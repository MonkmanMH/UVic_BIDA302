...
Please refer to [_R for Data Science_, 2nd ed., Data transformation](https://r4ds.hadley.nz/data-transform) for more information about this section.
...
> see [_R for Data Science_, 2nd ed., "Comparisions"](https://r4ds.hadley.nz/logicals.html#comparisons) and ["Boolean algebra"](https://r4ds.hadley.nz/logicals.html#boolean-algebra).]
...
> **IMPORTANT NOTE**
> The pipe operator `|>` is in base R, but it wasn't always. Prior to its introduction there was a pipe symbol available through the {magrittr} package, which looks like this: `%>%`. You will still see this version in older texts (such as the first edition of _R for Data Science_) and course materials (such as BIDA302!)
...
.footnote[see [_R for Data Science_, 2nd ed., "Comparisions""](https://r4ds.hadley.nz/logicals.html#comparisons) and ["Boolean algebra"](https://r4ds.hadley.nz/logicals.html#boolean-algebra).]
