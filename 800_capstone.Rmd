...
You can add documentation as both comments inside code chunks and text outside. Things to think about adding are:
...
For an example of what your documentation might look lik, refer to the chapter from Week 1, [An example of a data analytics project](#walkthrough).
