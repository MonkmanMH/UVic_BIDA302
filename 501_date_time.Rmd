...
["Dates and times" in _R for Data Science_ (2nd ed.)](https://r4ds.hadley.nz/datetimes) by Hadley Wickham and Garrett Grolemund
...
The answer to all of these is "no". (See the introduction to the ["Dates and Times"](https://r4ds.hadley.nz/datetimes#introduction) chapter of _R for Data Science_ (2nd ed.) for explanations.)
